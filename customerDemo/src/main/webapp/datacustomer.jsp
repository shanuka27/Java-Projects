    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
          ...
          <!-- <div class="content-wrapper"> -->
			...
			%>
				<h1 align="center"><font><strong>Registered Users</strong></font></h3><br>
				<h3 align="center">All the Register users are here....</h3><br>
				...
				<td style="display:none;"><b>Delete</b></td>
				</tr>
			<%
				try{ 
