    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
          ...
          <!-- <div class="content-wrapper"> -->
			...
			%>
				<h1 align="center"><font><strong>Customer Problems</strong></font></h3><br>
				<h3 align="center">All messages are here....</h3><br>
				<table align="center" cellpadding="10"   
				 id="responsive-data-table" class="table dt-responsive nowrap" style="width:100%">
				...
				<td style="display:none;"><b>View</b></td>
				</tr>
			<%
				try{ 
			...
			%>
				...
				<td><%=rs.getString("feedid") %></td>
				<td><%=rs.getString("feedname") %></td>
				<td><%=rs.getString("feedemail") %></td>
				<td><%=rs.getString("feedphone") %></td>
