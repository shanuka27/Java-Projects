  ...
  <body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
    ...
    <div class="wrapper">
                ...
                <li class="has-sub ">
                  ...
                  <ul class="collapse " id="forms" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      ...
                      <li class="">
                        <a class="sidenav-item-link" href="datacproduct.jsp">
        ...
        <div class="page-wrapper">
          ...
          <h1 align="center">All Products</h1><br>
	<h3 align="center">Summary of product is here....</h3><br>
        <table align="center" id="responsive-data-table" class="table dt-responsive nowrap" style="width:100%" border="2">
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String filename = rs.getString("pthumbnail");
        ...
        %>
            ...
            <tr>
                ...
                <td><%=productname%></td>
                <td><%=description%></td>
                <td><img src="productimage/<%=filename%>" width="100" height="100" alt =" "/></td>
                <td><%=price%></td>
