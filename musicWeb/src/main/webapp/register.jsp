...
<div class="card">
  ...
  <form action="register" method = "POST">
    ...
    <h2 class="h3 mb-3 fw-normal" style = "align-items: center;">Create Account</h2>

    <div class="form-floating">
      <input type="text" name = "name" class="form-control" id="floatingInput" placeholder="" style="
    margin-top: 10px;
">
      <label for="floatingInput">Name</label>
    </div>
    <div class="form-floating">
      <input type="email" name = "email" class="form-control" id="floatingInput" placeholder="" style="
    margin-top: 10px;
">
