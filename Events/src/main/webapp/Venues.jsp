    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
          ...
          <!-- <div class="content-wrapper"> -->
            <h1 align="center">ALL Venues </h1><br>
        ...
        %>
            ...
            <tr>
                ...
                <c:url value="venueupdate.jsp" var="vnuupdate">
					<c:param name="id" value="<%=id%>"/>
					<c:param name="venueName" value="<%=venuename%>"/>
					<c:param name="address" value="<%=address%>"/>
					<c:param name="capacity" value="<%=capacity%>"/>
					<c:param name="amei" value="<%=amen%>"/>
				</c:url>
				
				<c:url value="venuedelete.jsp" var="vnudelete">
					<c:param name="id" value="<%=id%>"/>
					<c:param name="venueName" value="<%=venuename%>"/>
					<c:param name="address" value="<%=address%>"/>
					<c:param name="capacity" value="<%=capacity%>"/>
                ...
                <td><a href="${vnuupdate}"><button class="btn btn-success">Update</button></a>
                	<a href="${vnudelete}"><button class="btn btn-danger">Delete</button></a></td>
