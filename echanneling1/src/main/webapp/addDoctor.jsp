          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form action = "adddoctor" method = "POST" class="mx-1 mx-md-4">

                  <div class="mb-3">
                    <div class="form-outline flex-fill mb-0">
                    	<label class="form-label" for="form3Example1c">Doctor Name</label>
                  ...
                  <div class="mb-3">
                    <div class="form-outline flex-fill mb-0">
                    	<label class="form-label" for="form3Example3c">Area (City)</label>
                      	<input name = "area" type="text" id="form3Example3c" class="form-control" />
                      
                    </div>
                  </div>

				  <div class="mb-3">
					<label class="form-label">Select Doctor Type</label>
